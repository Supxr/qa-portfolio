...
**Link to Test:** [TC_SD_34](/Test-Cases/SauceDemo/4-Checkout-Page/TC_SD34_BLANK_FIRST_NAME.md)

---
##Description:
The system accepts blankspaces into the first name field as valid characters, and allows the user to proceed to checkout.
...
8. Click `Checkout`
9. Enter first name: `     ` (5 blankspaces)
...
---
##Screenshots:
![blankspace_first_name](https://github.com/user-attachments/assets/6aed2c0f-d642-40b9-95a3-fc3d4b7a81e3)
