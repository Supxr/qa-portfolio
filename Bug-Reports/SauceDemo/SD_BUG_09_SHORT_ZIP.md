# Bug Report: System Allowing Short Zip Code
...
**Link to Test:** [TC_SD_38](/Test-Cases/SauceDemo/4-Checkout-Page/TC_SD38_SHORT_ZIP.md)

---
## Description:
The system accepts a zip code that is too short (less than 5 characters), and allows the user to proceed to checkout.
...
---
## Actual Result(s):
The system allows the user to proceed to the Checkout: Overview screen with a short zip code.

---
## Screenshots:
![short_zip](https://github.com/user-attachments/assets/f2186b7c-fb3d-4e22-a042-e68da3e51f95)
...
- However, most e-commerce platforms prevents users from inputting a short zip code as it may cause an error in delivery.
