...
These test cases validate the **product sorting via filters**, **Product addition/removal from shopping cart**, **dedicated product details**, **`Add to cart`/`Remove`/`Back to products` button functionality**, and **alternative product addition/removal pathways**.
