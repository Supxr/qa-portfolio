...
**Expected Result(s):** The system prevents the user from continuing, and provides an error message for only blankspaces in the first name field.<br>

**Actual Result(s):** The system allows the user to proceed to the `Checkout: Overview` screen with only blankspaces in the first name field.<br><br>
